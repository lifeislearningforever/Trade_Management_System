    ...
    def update_security(security_id: int, security_data: Dict[str, Any], updated_by: str) -> bool:
        ...
        try:
            ...
            updatable_fields = [
                ...
                'country_of_primary_exchange', 'udf_country_issue', 'exchange_code', 'currency_code',
                'shares_outstanding', 'beta', 'par_value', 'price_source',
                'pct_hld_entity_1', 'pct_hld_entity_2', 'pct_hld_entity_3', 'pct_hld_entity_aggr',
                'substantial_10_pct', 'pevc_s32_devest', 's32_representative',
                'approved_s32', 'fintech_speculative', 'unlistedeq_speculative', 'related_company',
                'mas_6d_code', 'mas_643_entity_type', 'fin_nonfin_ind', 'base_liv_fund',
                'fund_index_fund', 'core_noncore', 'management_limit_classification', 'relative_index',
                'business_unit_head', 'person_in_charge',
                'status',
            ]
