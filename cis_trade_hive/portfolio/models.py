...
class Portfolio(BaseModel):
    ...
    # Settlement currency — may differ from portfolio base currency
    settlement_ccy = models.CharField(max_length=10, blank=True, default='',
                                      help_text="Settlement currency code e.g. SGD, USD")
