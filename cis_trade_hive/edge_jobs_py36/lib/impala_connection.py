"""
Impala/Kudu Connection Manager (Python 3.6 / Django-free fork)

Forked from core/repositories/impala_connection.py for the standalone
edge-node commands in this package -- see edge_jobs_py36/lib/__init__.py
for why. Business logic is otherwise unchanged; only the settings import
is redirected to the local config shim.
