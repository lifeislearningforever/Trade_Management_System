...
def main():
    ...
    with open(gunicorn_conf, "w") as _f:
        _f.write(f"""# Auto-generated by cml_app.py — do not edit manually
bind = '{bind}'
workers = {workers}
...
errorlog  = '-'
loglevel  = 'info'
# Workers must NOT call cml_app.main() — they only serve ASGI requests.
# All background threads (TradeEventWorker, PositionWorker, HealthMonitor)
# are already running in the parent process before gunicorn forks.
""")
