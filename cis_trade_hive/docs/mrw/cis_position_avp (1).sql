...
-- First, identify ISINs that have multiple active records in cis_security
...
-- ============================================================================
-- STEP 5B: Insert NEW securities into cis_security
-- ============================================================================
...
SELECT
    ...
    CASE
        WHEN b.`exchange` IS NULL OR TRIM(b.`exchange`) = '' THEN 'FAIL: Exchange is null'
        ELSE 'PASS'
