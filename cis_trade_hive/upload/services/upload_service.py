            ...
            STANDARDIZE_SELECT = {
                ...
                'cis_user_sta_adhoc_position_5': f"""
                    SELECT
                        ...
                        ticker                                          AS ticker,
                        CAST(NULLIF(regexp_extract(TRIM(CAST(quantity AS STRING)),          '^-?[0-9]+(\\.[0-9]+)?', 0), '') AS DECIMAL(18,4)) AS quantity,
                        CAST(NULLIF(regexp_extract(TRIM(CAST(shares_outstanding AS STRING)), '^-?[0-9]+(\\.[0-9]+)?', 0), '') AS DECIMAL(18,4)) AS shares_outstanding,
                        CAST(NULLIF(regexp_extract(TRIM(CAST(shares_issued AS STRING)),      '^-?[0-9]+(\\.[0-9]+)?', 0), '') AS DECIMAL(18,4)) AS shares_issued,
                        CAST(NULLIF(regexp_extract(TRIM(CAST(pct_holding AS STRING)),        '^-?[0-9]+(\\.[0-9]+)?', 0), '') AS DECIMAL(10,6)) AS pct_holding,
                        CAST(NULLIF(regexp_extract(TRIM(CAST(market_price AS STRING)),       '^-?[0-9]+(\\.[0-9]+)?', 0), '') AS DECIMAL(18,6)) AS market_price,
                        CAST(NULLIF(regexp_extract(TRIM(CAST(average_cost AS STRING)),       '^-?[0-9]+(\\.[0-9]+)?', 0), '') AS DECIMAL(18,6)) AS average_cost,
                        CAST(NULLIF(regexp_extract(TRIM(CAST(cost_fc AS STRING)),            '^-?[0-9]+(\\.[0-9]+)?', 0), '') AS DECIMAL(18,4)) AS cost_fc,
                        CAST(NULLIF(regexp_extract(TRIM(CAST(market_value_fc AS STRING)),    '^-?[0-9]+(\\.[0-9]+)?', 0), '') AS DECIMAL(18,4)) AS market_value_fc,
                        CAST(NULLIF(regexp_extract(TRIM(CAST(net_book_value_fc AS STRING)),  '^-?[0-9]+(\\.[0-9]+)?', 0), '') AS DECIMAL(18,4)) AS net_book_value_fc,
                        CAST(NULLIF(regexp_extract(TRIM(CAST(unrealized_pnl_fc AS STRING)),  '^-?[0-9]+(\\.[0-9]+)?', 0), '') AS DECIMAL(18,4)) AS unrealized_pnl_fc,
                        ...
                        CAST(NULLIF(regexp_extract(TRIM(CAST(net_book_value_lc AS STRING)),  '^-?[0-9]+(\\.[0-9]+)?', 0), '') AS DECIMAL(18,4)) AS net_book_value_lc,
                        CAST(NULLIF(regexp_extract(TRIM(CAST(unrealized_pnl_lc AS STRING)),  '^-?[0-9]+(\\.[0-9]+)?', 0), '') AS DECIMAL(18,4)) AS unrealized_pnl_lc,
