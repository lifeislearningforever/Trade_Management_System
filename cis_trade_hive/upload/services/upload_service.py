            ...
            STANDARDIZE_SELECT = {
                ...
                'cis_user_sta_adhoc_position_1': f"""
                    SELECT
                        ...
                        NULL                                            AS ticker,
                        CAST(NULLIF(TRIM(CAST(quantity_today AS STRING)), '') AS DECIMAL(18,4)) AS quantity,
                ...
                'cis_user_sta_adhoc_position_2': f"""
                    SELECT
                        ...
                        isin_code                                       AS isin_code,
                        NULL                                            AS ticker,
                        CAST(NULLIF(TRIM(CAST(qty_held AS STRING)), '') AS DECIMAL(18,4))      AS quantity,
                        CAST(NULLIF(TRIM(CAST(shares_issued AS STRING)), '') AS DECIMAL(18,4)) AS shares_outstanding,
                        NULL                                                                   AS shares_issued,
                        CAST(NULLIF(TRIM(CAST(pct_holding AS STRING)), '') AS DECIMAL(10,6))   AS pct_holding,
                        NULL                                            AS market_price,
                        NULL                                            AS average_cost,
                        NULL                                            AS cost_fc,
                        NULL                                            AS market_value_fc,
                ...
                'cis_user_sta_adhoc_position_3': f"""
                    SELECT
                        ...
                        isin                                            AS isin_code,
                        NULL                                            AS ticker,
                        CAST(NULLIF(TRIM(CAST(shares_par_value AS STRING)), '') AS DECIMAL(18,4))        AS quantity,
                        CAST(NULLIF(TRIM(CAST(shares_outstanding_total AS STRING)), '') AS DECIMAL(18,4)) AS shares_outstanding,
                        NULL                                            AS shares_issued,
                        NULL                                            AS pct_holding,
                        NULL                                            AS market_price,
                        NULL                                            AS average_cost,
                ...
                'cis_user_sta_adhoc_position_4': f"""
                    SELECT
                        ...
                        CAST(NULLIF(TRIM(CAST(quantity AS STRING)), '') AS DECIMAL(18,4))                          AS quantity,
                        CAST(NULLIF(TRIM(CAST(no_of_shares_issues_by_the_company AS STRING)), '') AS DECIMAL(18,4)) AS shares_outstanding,
                        CAST(NULLIF(TRIM(CAST(no_of_shares_issues_by_the_company AS STRING)), '') AS DECIMAL(18,4)) AS shares_issued,
                        CAST(NULLIF(TRIM(CAST(pct_holdings AS STRING)), '') AS DECIMAL(10,6))                       AS pct_holding,
                        NULL                                                AS market_price,
                        NULL                                                AS average_cost,
                        CAST(NULLIF(TRIM(CAST(cost_fc AS STRING)), '') AS DECIMAL(18,4))          AS cost_fc,
                        NULL                                                AS market_value_fc,
                        CAST(NULLIF(TRIM(CAST(net_book_value_fc AS STRING)), '') AS DECIMAL(18,4)) AS net_book_value_fc,
                        NULL                                                AS unrealized_pnl_fc,
                        NULL                                                AS provision_fc,
                        CAST(NULLIF(TRIM(CAST(cost_lc AS STRING)), '') AS DECIMAL(18,4))          AS cost_lc,
                        NULL                                                AS market_value_lc,
                        CAST(NULLIF(TRIM(CAST(net_book_value_lc AS STRING)), '') AS DECIMAL(18,4)) AS net_book_value_lc,
                        NULL                                                AS unrealized_pnl_lc,
                        NULL                                                AS provision_lc,
                ...
                'cis_user_sta_adhoc_position_5': f"""
                    SELECT
                        ...
                        ticker                                          AS ticker,
                        CAST(NULLIF(TRIM(CAST(quantity AS STRING)), '') AS DECIMAL(18,4))          AS quantity,
                        CAST(NULLIF(TRIM(CAST(shares_outstanding AS STRING)), '') AS DECIMAL(18,4)) AS shares_outstanding,
                        CAST(NULLIF(TRIM(CAST(shares_issued AS STRING)), '') AS DECIMAL(18,4))      AS shares_issued,
                        CAST(NULLIF(TRIM(CAST(pct_holding AS STRING)), '') AS DECIMAL(10,6))        AS pct_holding,
                        CAST(NULLIF(TRIM(CAST(market_price AS STRING)), '') AS DECIMAL(18,6))       AS market_price,
                        CAST(NULLIF(TRIM(CAST(average_cost AS STRING)), '') AS DECIMAL(18,6))       AS average_cost,
                        CAST(NULLIF(TRIM(CAST(cost_fc AS STRING)), '') AS DECIMAL(18,4))            AS cost_fc,
                        CAST(NULLIF(TRIM(CAST(market_value_fc AS STRING)), '') AS DECIMAL(18,4))    AS market_value_fc,
                        CAST(NULLIF(TRIM(CAST(net_book_value_fc AS STRING)), '') AS DECIMAL(18,4))  AS net_book_value_fc,
                        CAST(NULLIF(TRIM(CAST(unrealized_pnl_fc AS STRING)), '') AS DECIMAL(18,4))  AS unrealized_pnl_fc,
                        CAST(NULLIF(TRIM(CAST(provision_fc AS STRING)), '') AS DECIMAL(18,4))       AS provision_fc,
                        CAST(NULLIF(TRIM(CAST(cost_lc AS STRING)), '') AS DECIMAL(18,4))            AS cost_lc,
                        CAST(NULLIF(TRIM(CAST(market_value_lc AS STRING)), '') AS DECIMAL(18,4))    AS market_value_lc,
                        CAST(NULLIF(TRIM(CAST(net_book_value_lc AS STRING)), '') AS DECIMAL(18,4))  AS net_book_value_lc,
                        CAST(NULLIF(TRIM(CAST(unrealized_pnl_lc AS STRING)), '') AS DECIMAL(18,4))  AS unrealized_pnl_lc,
                        CAST(NULLIF(TRIM(CAST(provision_lc AS STRING)), '') AS DECIMAL(18,4))       AS provision_lc,
