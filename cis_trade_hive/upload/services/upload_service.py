        ...
        try:
            ...
            STANDARDIZE_SELECT = {
                ...
                'cis_user_sta_adhoc_position_1': f"""
                    SELECT
                        ...
                        NULL                                            AS ticker,
                        CAST(quantity_today AS DECIMAL(18,4))           AS quantity,
                ...
                'cis_user_sta_adhoc_position_2': f"""
                    SELECT
                        ...
                        isin_code                                       AS isin_code,
                        NULL                                            AS ticker,
                        CAST(qty_held AS DECIMAL(18,4))                 AS quantity,
                        CAST(shares_issued AS DECIMAL(18,4))            AS shares_outstanding,
                        NULL                                            AS shares_issued,
                        CAST(pct_holding AS DECIMAL(18,4))              AS pct_holding,
                        NULL                                            AS market_price,
                        NULL                                            AS average_cost,
                        NULL                                            AS cost_fc,
                        NULL                                            AS market_value_fc,
                ...
                'cis_user_sta_adhoc_position_3': f"""
                    SELECT
                        ...
                        isin                                            AS isin_code,
                        NULL                                            AS ticker,
                        CAST(shares_par_value AS DECIMAL(18,4))         AS quantity,
                        CAST(shares_outstanding_total AS DECIMAL(18,4)) AS shares_outstanding,
                        NULL                                            AS shares_issued,
                        NULL                                            AS pct_holding,
                        NULL                                            AS market_price,
                        NULL                                            AS average_cost,
                ...
                'cis_user_sta_adhoc_position_4': f"""
                    SELECT
                        ...
                        CAST(no_of_shares_issues_by_the_company AS DECIMAL(18,4)) AS shares_outstanding,
                        CAST(no_of_shares_issues_by_the_company AS DECIMAL(18,4)) AS shares_issued,
                        CAST(pct_holdings AS DECIMAL(18,4))                 AS pct_holding,
                        NULL                                                AS market_price,
                        NULL                                                AS average_cost,
                        CAST(cost_fc AS DECIMAL(18,4))                      AS cost_fc,
                        NULL                                                AS market_value_fc,
                        CAST(net_book_value_fc AS DECIMAL(18,4))            AS net_book_value_fc,
                        NULL                                                AS unrealized_pnl_fc,
                        NULL                                                AS provision_fc,
                ...
                'cis_user_sta_adhoc_position_5': f"""
                    SELECT
                        ...
                        ticker                                          AS ticker,
                        CAST(quantity AS DECIMAL(18,4))                 AS quantity,
                        CAST(shares_outstanding AS DECIMAL(18,4))       AS shares_outstanding,
                        CAST(shares_issued AS DECIMAL(18,4))            AS shares_issued,
                        CAST(pct_holding AS DECIMAL(18,4))              AS pct_holding,
                        CAST(market_price AS DECIMAL(18,6))             AS market_price,
                        CAST(average_cost AS DECIMAL(18,6))             AS average_cost,
                        CAST(cost_fc AS DECIMAL(18,4))                  AS cost_fc,
                        CAST(market_value_fc AS DECIMAL(18,4))          AS market_value_fc,
                        CAST(net_book_value_fc AS DECIMAL(18,4))        AS net_book_value_fc,
            ...
            ok = impala_manager.execute_write(
                ...
                SELECT
                    ...
                    COALESCE(pct_holding,         CAST(0 AS DECIMAL(18,4))) AS pct_holding,
                    market_price,
                    average_cost,
