            ...
            STANDARDIZE_SELECT = {
                ...
                'cis_user_sta_adhoc_position_1': f"""
                    SELECT
                        ...
                        isin_code                                       AS isin,
                        NULL                                            AS ticker,
                        CAST(NULLIF(regexp_extract(TRIM(CAST(quantity_today AS STRING)), '^-?[0-9]+(\\.[0-9]+)?', 0), '') AS DOUBLE) AS quantity,
                ...
                'cis_user_sta_adhoc_position_2': f"""
                    SELECT
                        ...
                        isin_code                                       AS isin,
                        NULL                                            AS ticker,
                        CAST(NULLIF(regexp_extract(TRIM(CAST(qty_held AS STRING)),      '^-?[0-9]+(\\.[0-9]+)?', 0), '' ) AS DOUBLE) AS quantity,
                        CAST(NULLIF(regexp_extract(TRIM(CAST(shares_issued AS STRING)), '^-?[0-9]+(\\.[0-9]+)?', 0), '' ) AS DOUBLE) AS shares_outstanding,
                        NULL                                                                                                     AS shares_issued,
                        CAST(NULLIF(regexp_extract(TRIM(CAST(pct_holding AS STRING)),   '^-?[0-9]+(\\.[0-9]+)?', 0), '' ) AS DOUBLE) AS pct_holding,
                        NULL                                            AS market_price,
                        NULL                                            AS average_cost,
                        NULL                                            AS cost_fc,
                        NULL                                            AS market_value_fc,
                ...
                'cis_user_sta_adhoc_position_3': f"""
                    SELECT
                        ...
                        isin                                            AS isin,
                        NULL                                            AS ticker,
                        CAST(NULLIF(regexp_extract(TRIM(CAST(shares_par_value AS STRING)),        '^-?[0-9]+(\\.[0-9]+)?', 0), '' ) AS DOUBLE) AS quantity,
                        CAST(NULLIF(regexp_extract(TRIM(CAST(shares_outstanding_total AS STRING)), '^-?[0-9]+(\\.[0-9]+)?', 0), '' ) AS DOUBLE) AS shares_outstanding,
                        NULL                                            AS shares_issued,
                        NULL                                            AS pct_holding,
                        NULL                                            AS market_price,
                        NULL                                            AS average_cost,
                ...
                'cis_user_sta_adhoc_position_4': f"""
                    SELECT
                        ...
                        CAST(NULLIF(regexp_extract(TRIM(CAST(quantity AS STRING)),                          '^-?[0-9]+(\\.[0-9]+)?', 0), '' ) AS DOUBLE) AS quantity,
                        CAST(NULLIF(regexp_extract(TRIM(CAST(no_of_shares_issues_by_the_company AS STRING)), '^-?[0-9]+(\\.[0-9]+)?', 0), '' ) AS DOUBLE) AS shares_outstanding,
                        CAST(NULLIF(regexp_extract(TRIM(CAST(no_of_shares_issues_by_the_company AS STRING)), '^-?[0-9]+(\\.[0-9]+)?', 0), '' ) AS DOUBLE) AS shares_issued,
                        CAST(NULLIF(regexp_extract(TRIM(CAST(pct_holdings AS STRING)),                       '^-?[0-9]+(\\.[0-9]+)?', 0), '' ) AS DOUBLE) AS pct_holding,
                        NULL                                                AS market_price,
                        NULL                                                AS average_cost,
                        CAST(NULLIF(regexp_extract(TRIM(CAST(cost_fc AS STRING)),          '^-?[0-9]+(\\.[0-9]+)?', 0), '' ) AS DOUBLE) AS cost_fc,
                        NULL                                                AS market_value_fc,
                        CAST(NULLIF(regexp_extract(TRIM(CAST(net_book_value_fc AS STRING)), '^-?[0-9]+(\\.[0-9]+)?', 0), '' ) AS DOUBLE) AS net_book_value_fc,
                        NULL                                                AS unrealized_pnl_fc,
                        NULL                                                AS provision_fc,
                        CAST(NULLIF(regexp_extract(TRIM(CAST(cost_lc AS STRING)),          '^-?[0-9]+(\\.[0-9]+)?', 0), '' ) AS DOUBLE) AS cost_lc,
                        NULL                                                AS market_value_lc,
                        CAST(NULLIF(regexp_extract(TRIM(CAST(net_book_value_lc AS STRING)), '^-?[0-9]+(\\.[0-9]+)?', 0), '' ) AS DOUBLE) AS net_book_value_lc,
                        NULL                                                AS unrealized_pnl_lc,
                        NULL                                                AS provision_lc,
                ...
                'cis_user_sta_adhoc_position_5': f"""
                    SELECT
                        ...
                        CAST(NULLIF(regexp_extract(TRIM(CAST(no_of_shares_issues_by_the_company AS STRING)),   '^-?[0-9]+(\\.[0-9]+)?', 0), '' ) AS DOUBLE) AS shares_issued,
                        CAST(NULLIF(regexp_extract(TRIM(CAST(pct_holdings AS STRING)),                         '^-?[0-9]+(\\.[0-9]+)?', 0), '' ) AS DOUBLE) AS pct_holding,
                        CAST(NULLIF(regexp_extract(TRIM(CAST(market_price_unit_fc AS STRING)),                 '^-?[0-9]+(\\.[0-9]+)?', 0), '' ) AS DOUBLE) AS market_price,
                        CAST(NULLIF(regexp_extract(TRIM(CAST(unit_avg_cost_unit_fc AS STRING)),                '^-?[0-9]+(\\.[0-9]+)?', 0), '' ) AS DOUBLE) AS average_cost,
                        CAST(NULLIF(regexp_extract(TRIM(CAST(cost_fc AS STRING)),                              '^-?[0-9]+(\\.[0-9]+)?', 0), '' ) AS DOUBLE) AS cost_fc,
                        CAST(NULLIF(regexp_extract(TRIM(CAST(market_value_fc AS STRING)),                      '^-?[0-9]+(\\.[0-9]+)?', 0), '' ) AS DOUBLE) AS market_value_fc,
                        CAST(NULLIF(regexp_extract(TRIM(CAST(net_book_value_fc AS STRING)),                    '^-?[0-9]+(\\.[0-9]+)?', 0), '' ) AS DOUBLE) AS net_book_value_fc,
                        CAST(NULLIF(regexp_extract(TRIM(CAST(unrealised_gain_loss_fc AS STRING)),              '^-?[0-9]+(\\.[0-9]+)?', 0), '' ) AS DOUBLE) AS unrealized_pnl_fc,
                        CAST(NULLIF(regexp_extract(TRIM(CAST(provision_fc AS STRING)),                         '^-?[0-9]+(\\.[0-9]+)?', 0), '' ) AS DOUBLE) AS provision_fc,
                        CAST(NULLIF(regexp_extract(TRIM(CAST(cost_lc AS STRING)),                              '^-?[0-9]+(\\.[0-9]+)?', 0), '' ) AS DOUBLE) AS cost_lc,
                        CAST(NULLIF(regexp_extract(TRIM(CAST(market_value_lc AS STRING)),                      '^-?[0-9]+(\\.[0-9]+)?', 0), '' ) AS DOUBLE) AS market_value_lc,
                        CAST(NULLIF(regexp_extract(TRIM(CAST(net_book_value_lc AS STRING)),                    '^-?[0-9]+(\\.[0-9]+)?', 0), '' ) AS DOUBLE) AS net_book_value_lc,
                        CAST(NULLIF(regexp_extract(TRIM(CAST(unrealised_gain_loss_lc AS STRING)),              '^-?[0-9]+(\\.[0-9]+)?', 0), '' ) AS DOUBLE) AS unrealized_pnl_lc,
                        CAST(NULLIF(regexp_extract(TRIM(CAST(provision_lc AS STRING)),                         '^-?[0-9]+(\\.[0-9]+)?', 0), '' ) AS DOUBLE) AS provision_lc,
