...
--     - position_basis: 'TRADE_DATE' or 'SETTLE_DATE'
--     - position_date:  the effective date for this basis
--                       (trade_date for TRADE_DATE, settle_date for SETTLE_DATE)
--
...
-- ============================================================================
-- BACKFILL existing rows (all pre-dual-logic rows are SETTLE_DATE basis)
-- ============================================================================
...
-- SET position_basis = 'SETTLE_DATE', position_date = settle_date
