...
CREATE TABLE IF NOT EXISTS cis_trade_position (
    ...
    -- DECIMAL(28,8): 20 integer digits to handle large LC values (FC cost * FX rate)
    ...
    commit_fc                   DECIMAL(28,8),
    commit_lc                   DECIMAL(28,8),
    -- Provision (from ALTER 24)
    provision_fc                DECIMAL(28,8),
    provision_lc                DECIMAL(28,8),
