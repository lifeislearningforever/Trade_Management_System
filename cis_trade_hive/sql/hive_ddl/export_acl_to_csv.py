#!/usr/bin/env python3
"""
Export ACL data from Excel to CSV files for Hive loading

Usage:
    python export_acl_to_csv.py
"""
...
OUTPUT_DIR = '/Users/prakashhosalli/Personal_Data/Code/Django_projects/cis_trade_hive/Trade_Management_System/cis_trade_hive/sql/hive_ddl/acl_csv'

print("=" * 70)
print("Exporting ACL Data from Excel to CSV")
print("=" * 70)
print()
...
try:
    ...
    print()
    print("=" * 70)
    print("✓ SUCCESS! All data exported")
    print("=" * 70)
    print()
    print("Files created:")
    for sheet_name in xl.sheet_names:
