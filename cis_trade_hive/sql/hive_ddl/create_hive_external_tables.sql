...
CREATE EXTERNAL TABLE gmp_cis.hive_cis_trade (
    ...
    sec_fee                     DECIMAL(20,8),
    other_charges               DECIMAL(20,8),
    total_charges               DECIMAL(20,8),
    net_amount                  DECIMAL(20,8),
    gross_amount                DECIMAL(20,8),
    net_amount_lc               DECIMAL(20,8),
    gross_amount_lc             DECIMAL(20,8),
    fx_rate                     DECIMAL(20,8),
    accrued_interest            DECIMAL(20,8),
    accrued_interest_lc         DECIMAL(20,8),
    yield_rate                  DECIMAL(20,8),
    coupon_rate                 DECIMAL(20,8),
    isin                        STRING,
    description                 STRING,
    notes                       STRING,
